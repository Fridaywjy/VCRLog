...
class Node2Vec:
    ...
    def __init__(self, graph, walk_length, num_walks, p=0.5, q=0.5, workers=5, use_rejection_sampling=0):
    ...
    def train(self, embed_size=768, window_size=3, workers=5, iter=2, **kwargs):
